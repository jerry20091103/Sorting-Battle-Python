...
def Convert_ONNX(model_player, input_size = 50):
    ...
    # export the model
    torch.onnx.export(model_player.policy_network, dummy_input, "Sorting_battle_policy.onnx")
    torch.onnx.export(model_player.value_network, dummy_input, "Sorting_battle_value.onnx")
